...
function AjaxObjeto()
{
	...
	if(window.ActiveXObject)
	{
		for(let e of d)
		{
			...
			{
				console.error('Error: no se puede crear ActiveXObject.')
			}
		}
	}
	else 
...
{
    var w = 0, h = 0
    if(typeof window.innerWidth != 'undefined'){w = window.innerWidthh = window.innerHeight} 
    else if(typeof document.documentElement != 'undefined' && typeof document.documentElement.clientWidth != 'undefined' && document.documentElement.clientWidth != 0){w =  document.documentElement.clientWidthh = document.documentElement.clientHeight}
    else{w = document.body.clientWidthh = document.body.clientHeight}
